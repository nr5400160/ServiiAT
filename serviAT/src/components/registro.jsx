...
const MODO = "cliente"; // "server" = WorkBench | "cliente" = Supabase
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      */
        ...
        // Generamos la sal manualmente y usamos la versión Sync
        const salt = bcrypt.genSaltSync(12);
        const claveEncriptada = bcrypt.hashSync(formData.clave, salt);
        ...
        if (dirRes.error) throw dirRes.error;  //fin de supabase

        alert('¡Registro Exitoso!');
        navigate('/login');
      // } // Cierre del else comentado de Workbench
