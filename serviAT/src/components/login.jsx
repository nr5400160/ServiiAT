  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (MODO === "server") {
        ...
        console.log("Hash guardado en BD:", userData.clave);
        console.log("Longitud del hash:", userData.clave.length);

        // Usamos compareSync sin el await
        const claveValida = bcrypt.compareSync(password.trim(), userData.clave.trim());
